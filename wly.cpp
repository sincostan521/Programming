...
string findClosestZombie(int &row, int &column, string **arr, int **PositionZombie, int &zombie, Character::Zombie &zombies) // A calculater for finding the shortest distance between the alien and a zombie.
{
    ...
    for (int i = 0; i < (row); ++i)
    {
        for (int j = 0; j < (column); ++j)
        {
            if (arr[i][j] != "A" && arr[i][j] != "^" && arr[i][j] != "v" && arr[i][j] != "<" && arr[i][j] != ">" && arr[i][j] != "h" && arr[i][j] != "p" && arr[i][j] != "r" && arr[i][j] != " " && arr[i][j] != "." && arr[i][j] != "@")
            {
                int rowX = i;
                int colX = j;
...
void effect(int &row, bool &bossSpawn) // effect when the boss is spawn and after it is defeated.
{
    ...
    {
        system("cls");
        string s01 = "                                ____________                               ";
        string s02 = "                              /              \\                            ";
        string s03 = "                             /                \\ _____                     ";
        string s04 = "                            /                         \\ ____              ";
        string s05 = "                           /       ____             ____     \\            ";
        string s06 = "                          |      /      \\         /      \\    \\         ";
        string s07 = "                          |     |   00   |       |   @@   |    \\          ";
        string s08 = "                          |     |   00   |       |   @@   |     |          ";
        string s09 = "                          |      \\ ____ /         \\ ____ /      |        ";
        string s10 = "                          |                 /|\\                 |         ";
        string s11 = "                           \\               / | \\               /         ";
        string s12 = "                            \\ _           /__|__\\           _ /          ";
        string s13 = "                                \\                         /               ";
        string s14 = "                                 |     |_|_|_|_|_|_|     |                 ";
        string s15 = "                                 |                       |                 ";
        string s16 = "                                 |      _ _ _ _ _ _      |                 ";
        string s17 = "                                  \\    | | | | | | |    /                 ";
        string s18 = "                                   \\ _________________ /                  ";
...
void hitObject(string &hit, Character::Alien &aliens, Character::Zombie &zombies, string &lastMove, int &row, int &column, string **arr, int &x, int &y, int **PositionZombie, int &zombie, bool bossSpawn) // Display different outputs based on what it hits.
{
    string hitZombie = "0";
    for (int i = 1; i <= zombies.sizeZombie(); i++)
    {
...
string difficulty() // Menu for user to choose difficulty.
{
    ...
    do
    {
        ...
        {
            cout << "Please enter the correct difficulty !" << endl << endl;
            system("pause");
            error = true;
        }
        else
...
int main()
{
    ...
    while (exit != true)
    {
        ...
        else if (command == "up" || command == "down" || command == "left" || command == "right")
        {
            ...
            hitObject(hit, aliens, zombies, lastMove, row, column, arr, x, y, PositionZombie, zombie, bossSpawn);
            if (hit == "r")
            {
                alienHitRock = true;
            }
            ...
            if (zombies.accumulateZombieLife() == 0 && zombies.getBossLife(0) != 0)
            {
                ...
                if (bossSpawn == false)
                {
                    ...
                    if (mode == "easy")
                    {
                        ...
                        cout << "===============================" << endl;
                        cout << endl;
                        cout << "Alien reived 30 health points. " << endl;
